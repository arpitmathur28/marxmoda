				...
				<div class="successHeader">
					<div class="row">
						<div class="col-md-12 text-center">
							<img src="{{url('public/images/okIcon.png')}}" class="okIcon">
						</div>
						<div class="col-md-12 text-center">
							<h4><b>Thank You!</b></h4>
				...
				<div class="cardBody">
					<div class="row">
						...
						<div class="col-md-6 text-right">
							<h5>${{$paymentResult["payment_amount"]}}</h5>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<label class="topLabel leftcol">Invoice No.:- </label><label class="topLabel"><b>{{$paymentResult["invoice_no"]}}</b></label>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<label class="topLabel leftcol">Transaction Id:- </label><label class="topLabel"><b>{{$paymentResult["txnid"]}}</b></label>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<label class="topLabel leftcol">Date of Payment:- </label><label class="topLabel"><b>{{date("m-d-Y h:i:s", strtotime($paymentResult["created_at"]))}}</b></label>
						</div>
					</div>
